// // components/AdvancedQRCodeGenerator.tsx
...
//     switch (selectedTab) {
//       case "coffee":
//         return `${baseUrl}/${brand.id}?tab=coffee&utm_source=qr&utm_medium=offline&utm_campaign=brand_share`;
//       case "equipment":
//         return `${baseUrl}/${brand.id}?tab=equipment&utm_source=qr&utm_medium=offline&utm_campaign=brand_share`;
//       default:
//         return `${baseUrl}/${brand.id}?utm_source=qr&utm_medium=offline&utm_campaign=brand_share`;
//     }
//   };
...
//     const shareUrl = generateQRUrl(); // Use the full URL with UTMs for sharing
...
//         <span className="font-semibold">Share Collection</span>
//       </button>
...
//             {/* Display clean URL without UTMs for better UX */}
...
//             {/* Small note about analytics for transparency */}
//             <p className="text-xs text-gray-400 mt-4">
//               📊 Includes analytics parameters to help improve your experience
//             </p>
//           </div>
//         </div>
//       )}
