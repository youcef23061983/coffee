...
const AboutClient = () => {
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-amber-50/20 to-brown-900/10 py-12 px-4">
        {/* Hero Header */}
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-amber-50 to-amber-100/50 p-8 rounded-2xl border border-amber-200">
            ...
            <div className="bg-gradient-to-br from-brown-50 to-brown-100/50 p-8 rounded-2xl border border-brown-200">
              <h3 className="text-2xl font-bold text-brown-900 mb-4 flex items-center gap-3">
