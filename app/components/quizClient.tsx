    ...
    <>
      <section className="relative h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          >
            Take our quick quiz to discover coffee recommendations perfectly
            tailored to your taste preferences and brewing style.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-2xl mx-auto px-4">
          ...
          {loading && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white rounded-2xl p-8 text-center">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#c2a287] mx-auto mb-4"></div>
          ...
          <div className="mb-8">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <motion.div
                className="bg-[#b07d52] h-2 rounded-full"
                initial={{ width: 0 }}
            ...
            >
                    ...
                    className={`p-6 rounded-2xl border-2 text-left transition-all ${
                      currentQuestion.type === "multiple"
                        ? answers.flavorPreferences.includes(option.value)
                          ? "border-[#b07d52] bg-indigo-50"
                          : "border-gray-300 bg-white hover:border-[#fee6d2]"
              ...
              <div className="flex justify-between">
                ...
                <button
                  ...
                  className="bg-[#b07d52] text-white px-8 py-3 rounded-full font-semibold disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[#4d341f] transition-colors"
                >
